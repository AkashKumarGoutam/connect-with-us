        ...
        return (
          <>
            <div>
              <div className="flex flex-col p-4 border-2  m-4 shadow-xl ">
                ...
                <div className="flex flex-col mt-4">
                  ...
                  <div className="flex flex-row pt-6 justify-end">
                    <button className="border-2 bg-blue-700 text-white px-8 rounded-full p-1 flex flex-row ">
              ...
              {/* <div className="flex flex-col p-4 border-2  m-2  shadow-xl w-[90%]">
                <div className="flex ">
                  <img
                    src="../img/profilepic.jpg"
                    className="w-24 h-24 border-2 rounded-full  "
